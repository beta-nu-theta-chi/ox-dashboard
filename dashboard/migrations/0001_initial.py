# Generated by Django 3.0.7 on 2020-12-28 03:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bruh', models.BooleanField(default=True)),
                ('attendees_brothers', models.ManyToManyField(blank=True, to='dashboard.Brother')),
                ('eligible_attendees', models.ManyToManyField(blank=True, related_name='_event_eligible_attendees_+', to='dashboard.Brother')),
            ],
        ),
        migrations.CreateModel(
            name='MinecraftPhoto',
