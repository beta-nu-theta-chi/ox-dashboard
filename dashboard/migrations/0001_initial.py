# Generated by Django 3.0.7 on 2020-11-29 21:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendees_brothers', models.ManyToManyField(blank=True, to='dashboard.Brother')),
                ('committee', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='meetings', to='dashboard.Committee')),
                ('semester', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dashboard.Semester')),
            ],
            options={
                'abstract': False,
