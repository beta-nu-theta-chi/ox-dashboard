...
urlpatterns = [
    ...
    url(r'^secretary/excuse/(?P<excuse_id>[0-9]+)/quick_accept/$', views.excuse_quick_accept, name="excuse_quick_accept"),
    url(r'^secretary/excuse/(?P<excuse_id>[0-9]+)/$', views.excuse, name="secretary_excuse"),
